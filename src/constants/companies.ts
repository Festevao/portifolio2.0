export const companies = [
  {
    ...
    description: `\ A "Transformando Faces" é uma clínica de harmonização facial reconhecida no Brasil e no mundo
    \ pela excelência nos resultados e pelo cuidado com os clientes. Trabalhar lá foi uma experiência enriquecedora,
    \ onde vi de perto como o trabalho de alta qualidade e precisão pode impactar positivamente a vida das pessoas.
    \ Foi uma experiência que me mostrou como realmente a tecnologia deve ser usada para auxiliar os processos e pessoas`,
