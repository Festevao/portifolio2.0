const Footer = () => {
  ...
  return (
    <footer
      className="footer flex flex-col justify-between items-center w-full bg-black min-h-[155px] min-w-[250px] text-white text-xs sm:text-sm md:text-base"
      style={{
    ...
    >
      <div className="relative w-full lg:w-[80%] h-full flex flex-col lg:grid lg:grid-cols-2 gap-2">
      ...
      <div className="h-full w-full flex flex-col justify-center items-center">
        <span className="text-lg mb-4 leading-[15px] text-center">
          © <></>
          <span className="text-xs leading-[15px] text-start">
            {currentYear} - All Rights Reserved. Designed and Developed by Felipi Trindade
          </span>
        </span>
      </div>
    </footer>
