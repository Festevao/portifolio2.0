  ...
  return (
    <div className='w-[80%] flex flex-col justify-around min-h-[60vh]'>
      ...
      <div className='w-full flex flex-wrap gap-5 items-center justify-center lg:justify-center mb-10'>
        <ContactCard href='https://www.linkedin.com/in/felipi-trindade-365a34143/' imgUrl='/img/contact/linkedin.png' title='Linkedin' contactString='Ver perfil'/>
        <ContactCard href='https://github.com/Festevao' imgUrl='/img/contact/github.png' title='Github' contactString='Ver perfil'/>
        <ContactCard href='https://www.instagram.com/felipeestevaofm' imgUrl='/img/contact/instagram.png' title='Instagram' contactString='Ver perfil'/>
        <ContactCard href='https:wa.me/5532984680116' imgUrl='/img/contact/whatsapp.webp' title='Whatsapp' contactString='Enviar mensagem'/>
        <ContactCard href='mailto:cadefm@hotmail.com' imgUrl='/img/contact/email.webp' title='cadefm@hotmail.com' contactString='Enviar e-mail'/>
